---
name: estimate
description: 'Estimates task effort by analyzing complexity, dependencies, historical velocity, and risk factors. Produces a structured estimate with confidence levels. Arguments: [task-description]'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/estimate/SKILL.md -->
