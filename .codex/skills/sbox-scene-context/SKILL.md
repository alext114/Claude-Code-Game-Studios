...
description: 'Orient to the active s&box scene via MCP: query object counts, hierarchy, existing components, and editor state. Use this before any build task to establish a baseline and avoid duplicating existing work. Arguments: [optional: ''full'' for deep hierarchy scan, default is summary only]'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/sbox-scene-context/SKILL.md -->
