---
name: team-ui
description: 'Orchestrate the UI team through the full UX pipeline: from UX spec authoring through visual design, implementation, review, and polish. Integrates with $ux-design, $ux-review, and studio UX templates. Arguments: [UI feature description]'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/team-ui/SKILL.md -->
...
- `agent_type: ux-designer` — User flows, wireframes, accessibility, input handling
- `agent_type: ui-programmer` — UI framework, screens, widgets, data binding
- `agent_type: art-director` — Visual style, layout polish, art bible consistency
- `agent_type: [UI engine specialist]` — Engine-specific UI pattern validation (e.g., unity-ui-specialist, ue-umg-specialist, godot-specialist)
- `agent_type: accessibility-specialist` — Accessibility compliance audit
