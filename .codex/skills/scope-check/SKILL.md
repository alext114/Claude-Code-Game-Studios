---
name: scope-check
description: 'Analyze a feature or sprint for scope creep by comparing current scope against the original plan. Flags additions, quantifies bloat, and recommends cuts. Use when user says ''any scope creep'', ''scope review'', ''are we staying in scope''. Arguments: [feature-name or sprint-N]'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/scope-check/SKILL.md -->
