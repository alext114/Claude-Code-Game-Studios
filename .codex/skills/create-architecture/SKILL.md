...
description: 'Guided, section-by-section authoring of the master architecture document for the game. Reads all GDDs, the systems index, existing ADRs, and the engine reference library to produce a complete architecture blueprint before any code is written. Engine-version-aware: flags knowledge gaps and validates decisions against the pinned engine version. Arguments: [focus-area: full | layers | data-flow | api-boundaries | adr-audit] [--review full|lean|solo]'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/create-architecture/SKILL.md -->
...
**Step 2 — Spawn `lead-programmer` via spawn_agent using gate LP-FEASIBILITY (`.claude/docs/director-gates.md`):**
