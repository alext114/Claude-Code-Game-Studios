...
description: 'Assemble a complete playable level from CSG blocks via direct MCP calls. Guided workflow: gather layout requirements, create floor/wall/ceiling geometry, place structural elements, assign materials, and organize all geometry under a named root container. Arguments: [optional: level name or layout description, e.g., ''Warehouse'', ''Arena 2048x2048'']'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/sbox-build-level/SKILL.md -->
