...
description: 'Automatically analyze project state, detect stage, identify gaps, and recommend next steps based on existing artifacts. Use when user asks ''where are we in development'', ''what stage are we in'', ''full project audit''. Arguments: [optional: role filter like ''programmer'' or ''designer'']'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/project-stage-detect/SKILL.md -->
...
This is a mechanical read-and-format task. Do not over-deliberate — prefer speed over exhaustiveness.
