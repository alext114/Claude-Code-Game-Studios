...
description: 'Scaffold a new s&box Component with correct lifecycle methods, [Property] attributes, IsProxy guards, and XML doc comments. Writes to code/Components/. Arguments: <ComponentName> (e.g., ''HealthComponent'', ''WeaponController'')'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/sbox-create-component/SKILL.md -->
...
Ask the user (use request_user_input with multiple questions if helpful):
