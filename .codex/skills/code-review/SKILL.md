---
name: code-review
description: 'Performs an architectural and quality code review on a specified file or set of files. Checks for coding standard compliance, architectural pattern adherence, SOLID principles, testability, and performance concerns. Arguments: [path-to-file-or-directory]'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/code-review/SKILL.md -->

## Delegation (Codex)

Run this skill as the `lead-programmer` role: open with a `spawn_agent` call setting
`agent_type: lead-programmer`, and pass the user's request through as the `message`.
