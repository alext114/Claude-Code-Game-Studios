---
name: skill-improve
description: 'Improve a skill using a test-fix-retest loop. Runs static checks, proposes targeted fixes, rewrites the skill, re-tests, and keeps or reverts based on score change. Arguments: [skill-name]'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/skill-improve/SKILL.md -->
