---
name: art-bible
description: 'Guided, section-by-section Art Bible authoring. Creates the visual identity specification that gates all asset production. Run after $brainstorm is approved and before $map-systems or any GDD authoring begins. Arguments: [--review full|lean|solo]'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/art-bible/SKILL.md -->
...
After all sections are complete (or the scoped set from Phase 1 is complete), spawn `creative-director` via spawn_agent using gate **AD-ART-BIBLE** (`.claude/docs/director-gates.md`).
