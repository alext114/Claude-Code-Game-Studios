...
description: 'Create an AI navigation agent on a GameObject in the active s&box scene via MCP. Attaches NavMeshAgent component, configures movement parameters, and wires it to the existing NavMesh. Prerequisite: $sbox-setup-navmesh must be complete. Arguments: <EntityName> (e.g., ''Enemy'', ''Patrol_Guard'')'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/sbox-spawn-nav-agent/SKILL.md -->
