---
name: bug-report
description: 'Creates a structured bug report from a description, or analyzes code to identify potential bugs. Ensures every bug report has full reproduction steps, severity assessment, and context. Arguments: [description] | analyze [path-to-file]'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/bug-report/SKILL.md -->
