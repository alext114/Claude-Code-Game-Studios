---
name: start
description: 'First-time onboarding — asks where you are, then guides you to the right workflow. No assumptions. Arguments: [no arguments]'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/start/SKILL.md -->
