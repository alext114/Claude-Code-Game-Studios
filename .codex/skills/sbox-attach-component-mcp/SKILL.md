...
description: 'Attach a built-in s&box Component to an existing GameObject via MCP, configure its [Property] values, and verify the result. Use this for engine-native components (CharacterController, Rigidbody, etc.) without writing any C# code. Arguments: <EntityName> <ComponentType> (e.g., ''Player CharacterController'')'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/sbox-attach-component-mcp/SKILL.md -->
