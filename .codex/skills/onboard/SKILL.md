---
name: onboard
description: 'Generates a contextual onboarding document for a new contributor or agent joining the project. Summarizes project state, architecture, conventions, and current priorities relevant to the specified role or area. Arguments: [role|area]'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/onboard/SKILL.md -->
