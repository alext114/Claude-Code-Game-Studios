...
description: 'Scaffold a complete s&box PlayerController Component using the PlayerController + WishVelocity API (NOT CharacterController), configurable [Property] values, input handling in OnUpdate, physics in OnFixedUpdate, and IsProxy guards for multiplayer. Writes to Code/Components/PlayerController.cs. Arguments: [no arguments — guided workflow]'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/sbox-create-player-controller/SKILL.md -->
...
Ask these questions (can use request_user_input for grouped answers):
