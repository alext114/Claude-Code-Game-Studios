---
name: team-level
description: 'Orchestrate level design team: level-designer + narrative-director + world-builder + art-director + systems-designer + qa-tester for complete area/level creation. Arguments: [level name or area to design]'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/team-level/SKILL.md -->
...
- `agent_type: narrative-director` — Narrative purpose, characters, emotional arc
- `agent_type: world-builder` — Lore context, environmental storytelling, world rules
- `agent_type: level-designer` — Spatial layout, pacing, encounters, navigation
- `agent_type: systems-designer` — Enemy compositions, loot tables, difficulty balance
- `agent_type: art-director` — Visual theme, color palette, lighting, asset requirements
- `agent_type: accessibility-specialist` — Navigation clarity, colorblind safety, cognitive load
- `agent_type: qa-tester` — Test cases, boundary testing, playtest checklist
