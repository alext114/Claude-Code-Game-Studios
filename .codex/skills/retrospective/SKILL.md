---
name: retrospective
description: 'Generates a sprint or milestone retrospective by analyzing completed work, velocity, blockers, and patterns. Produces actionable insights for the next iteration. Arguments: [sprint-N|milestone-name]'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/retrospective/SKILL.md -->
