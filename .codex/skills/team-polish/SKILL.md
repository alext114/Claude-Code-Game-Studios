---
name: team-polish
description: 'Orchestrate the polish team: coordinates performance-analyst, technical-artist, sound-designer, and qa-tester to optimize, polish, and harden a feature or area for release quality. Arguments: [feature or area to polish]'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/team-polish/SKILL.md -->
...
- `agent_type: performance-analyst` — Profiling, optimization, memory analysis
- `agent_type: engine-programmer` — Engine-level fixes for rendering, memory, resource loading
- `agent_type: technical-artist` — VFX polish, shader optimization, visual quality
- `agent_type: sound-designer` — Audio polish, mixing, ambient layers
- `agent_type: tools-programmer` — Content pipeline and editor tool verification
- `agent_type: qa-tester` — Edge case testing, regression testing, soak testing
