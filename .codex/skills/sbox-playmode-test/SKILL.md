...
description: 'Enter s&box play mode via MCP, execute a structured runtime verification checklist, capture results, then return to editor mode. Use after any code or scene change to confirm behavior at runtime. Arguments: [optional: focus area, e.g., ''movement'', ''navmesh'', ''ui'']'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/sbox-playmode-test/SKILL.md -->
