...
description: 'Capture a fully-configured s&box GameObject (with all components and children) from the active scene via MCP, serialize it to a .prefab file, and optionally replace the source with a prefab instance. Arguments: <EntityName> [optional: ''keep-source''] (e.g., ''Player'', ''Enemy keep-source'')'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/sbox-generate-prefab/SKILL.md -->
