...
description: 'Create and configure a CSG block mesh in the active s&box scene via MCP. Sets dimensions, applies materials to individual faces, and configures texture parameters. The foundation for procedural level geometry. Arguments: <BlockName> [dimensions WxHxD] (e.g., ''Floor 1024x64x1024'', ''Wall'')'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/sbox-sculpt-block/SKILL.md -->
