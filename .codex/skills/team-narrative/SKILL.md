---
name: team-narrative
description: 'Orchestrate the narrative team: coordinates narrative-director, writer, world-builder, and level-designer to create cohesive story content, world lore, and narrative-driven level design. Arguments: [narrative content description]'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/team-narrative/SKILL.md -->
...
- `agent_type: narrative-director` — Story arcs, character design, narrative vision
- `agent_type: writer` — Dialogue writing, lore entries, in-game text
- `agent_type: world-builder` — World rules, faction design, history, geography
- `agent_type: art-director` — Character visual profiles, environmental visual storytelling, cinematic tone
- `agent_type: level-designer` — Level layouts that serve the narrative, pacing
- `agent_type: localization-lead` — i18n validation, string key compliance, translation headroom
