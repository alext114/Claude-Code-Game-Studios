...
description: 'Generates a comprehensive milestone progress review including feature completeness, quality metrics, risk assessment, and go/no-go recommendation. Use at milestone checkpoints or when evaluating readiness for a milestone deadline. Arguments: [milestone-name|current] [--review full|lean|solo]'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/milestone-review/SKILL.md -->
...
Before generating the Go/No-Go recommendation, spawn `producer` via spawn_agent using gate **PR-MILESTONE** (`.claude/docs/director-gates.md`).
