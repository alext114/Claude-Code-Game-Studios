---
name: test-helpers
description: 'Generate engine-specific test helper libraries for the project''s test suite. Reads existing test patterns and produces tests/helpers/ with assertion utilities, factory functions, and mock objects tailored to the project''s systems. Reduces boilerplate in new test files. Arguments: [system-name | all | scaffold]'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/test-helpers/SKILL.md -->
