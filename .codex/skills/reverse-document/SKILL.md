...
description: 'Generate design or architecture documents from existing implementation. Works backwards from code/prototypes to create missing planning docs. Arguments: <type> <path> (e.g., ''design src/gameplay/combat'' or ''architecture src/core'')'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/reverse-document/SKILL.md -->
