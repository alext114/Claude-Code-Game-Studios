---
name: team-live-ops
description: 'Orchestrate the live-ops team for post-launch content planning: coordinates live-ops-designer, economy-designer, analytics-engineer, community-manager, writer, and narrative-director to design and plan a season, event, or live content update. Arguments: [season name or event description]'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/team-live-ops/SKILL.md -->
...
- `agent_type: live-ops-designer` — Season/event structure and retention mechanics
- `agent_type: economy-designer` — Live economy balance and reward pricing
- `agent_type: analytics-engineer` — Success metrics, A/B tests, event instrumentation
- `agent_type: community-manager` — Player-facing communication and messaging
- `agent_type: narrative-director` — Seasonal theme and narrative framing
- `agent_type: writer` — All player-facing text: event descriptions, item names, copy
