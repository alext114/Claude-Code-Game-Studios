...
description: 'Holistic cross-GDD consistency and game design review. Reads all system GDDs simultaneously and checks for contradictions between them, stale references, ownership conflicts, formula incompatibilities, and game design theory violations (dominant strategies, economic imbalance, cognitive overload, pillar drift). Run after all MVP GDDs are written, before architecture begins. Arguments: [focus: full | consistency | design-theory | since-last-review]'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/review-all-gdds/SKILL.md -->
...
This is a high-stakes synthesis gate. Read every input in full and reason carefully across all of them before issuing a verdict.
