...
description: 'Map test coverage to GDD critical paths, identify fixed bugs without regression tests, flag coverage drift from new features, and maintain tests/regression-suite.md. Run after implementing a bug fix or before a release gate. Arguments: [update | audit | report]'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/regression-suite/SKILL.md -->
