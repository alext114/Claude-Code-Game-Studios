---
name: ux-review
description: 'Validates a UX spec, HUD design, or interaction pattern library for completeness, accessibility compliance, GDD alignment, and implementation readiness. Produces APPROVED / NEEDS REVISION / MAJOR REVISION NEEDED verdict with specific gaps. Arguments: [file-path or ''all'' or ''hud'' or ''patterns'']'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/ux-review/SKILL.md -->
