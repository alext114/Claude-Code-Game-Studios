...
description: 'Apply vertex colors and blend weights to CSG block geometry in the active s&box scene via MCP. Use for terrain-style surface blending, damage decals baked into geometry, or stylistic color variation on level blocks. Arguments: <BlockName or GUID> (e.g., ''Floor_Main'', ''Cover_01'')'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/sbox-vertex-paint/SKILL.md -->
