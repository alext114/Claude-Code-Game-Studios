...
description: 'Design and configure a complete AI enemy encounter zone in the active s&box scene via MCP. Creates spawn points, configures NavMesh agents, sets patrol routes, and establishes trigger volumes for encounter activation. Arguments: [optional: encounter name or zone description, e.g., ''WarehouseAmbush'']'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/sbox-build-ai-encounter/SKILL.md -->
