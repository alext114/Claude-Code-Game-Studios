...
description: 'Create a named GameObject in the active s&box scene via MCP. Sets position, rotation, scale, tags, and optional parent. Returns the GUID for use in follow-up component and property operations. Arguments: <EntityName> [optional: ''at X Y Z''] (e.g., ''Player at 0 64 0'', ''EnemySpawn'')'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/sbox-spawn-entity/SKILL.md -->
