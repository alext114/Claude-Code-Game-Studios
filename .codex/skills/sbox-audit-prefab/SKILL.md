...
description: 'Deep health check on a specific s&box prefab: verifies all instances are in sync, checks for missing components, validates component property ranges, and reports the prefab''s dependency tree. Arguments: <PrefabName> (e.g., ''Enemy'', ''Player'')'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/sbox-audit-prefab/SKILL.md -->
