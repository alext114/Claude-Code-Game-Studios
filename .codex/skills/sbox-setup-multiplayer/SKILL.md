...
description: 'Audit existing s&box Components for multiplayer correctness: checks IsProxy guards, identifies replicated state needing [Sync], reviews Rpc methods, and generates a NetworkSummary.md architecture document. Arguments: [optional: component name or ''audit'' to scan all code/Components/]'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/sbox-setup-multiplayer/SKILL.md -->
