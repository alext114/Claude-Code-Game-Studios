...
After decomposing all stories (Step 4 complete) but before presenting them for write approval, spawn `qa-lead` via spawn_agent using gate **QL-STORY-READY** (`.claude/docs/director-gates.md`).
