---
name: changelog
description: 'Auto-generates a changelog from git commits, sprint data, and design documents. Produces both internal and player-facing versions. Arguments: [version|sprint-number]'
---

<!-- GENERATED by tools/codex-sync — do not edit. Source: .claude/skills/changelog/SKILL.md -->
